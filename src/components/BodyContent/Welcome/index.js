  ...
  return (
    <div id="Welcome" className={cx('welcome_wrapper')}>
        <div className={cx('content')}>
            ...
            <p className={cx('welcome_desc')}>Xin chào! Tôi tên Thanh. Cảm ơn bạn đã ghé qua Portfolio của tôi. Hy vọng bạn sẽ xem và có thể cho tôi một số phản hồi. Cảm ơn bạn rất nhiều!</p>
